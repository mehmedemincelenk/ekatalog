...
- **Ghost Mode:** `ekatalog.co` ana sayfasında kayıt olmadan yapılan düzenlemeler `localStorage` veya geçici bir `session_id` ile Supabase'de tutulur. Kayıt (WhatsApp OK) sonrası bu veri dükkanla eşleştirilir.
